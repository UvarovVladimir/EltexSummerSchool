...
@MappedSuperclass
@ToString
abstract class User2 implements Comparable {
    // Comparable
    public String compareIdTo(User2 other){
    ...
    public String equalsFioTo(User2 other) {
        //Compare ID of other user and this user .Return String.
    ...
    //Constructors
    User2(Integer id, String fio, String phone, String email){
        this.id=id;
        this.fio=fio;
        this.phone=phone;
        this.email=email;
